...
export const CartDrawer = () => {
  ...
  const { items, updateQuantity, removeItem, setCheckoutUrl, setLoading, isLoading } = useCartStore();
            ...
            <>
              <div className="flex-1 overflow-y-auto pr-2 min-h-0">
                <div className="space-y-4">
                  {items.map((item) => (
                    <div key={item.variantId} className="flex gap-4 p-2 bg-secondary/20 rounded-lg">
